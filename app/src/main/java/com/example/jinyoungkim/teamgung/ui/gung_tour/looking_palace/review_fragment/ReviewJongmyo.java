...
public class ReviewJongmyo extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_review_jongmyo,container,false);
        networkService = GlobalApplication.getGlobalApplicationContext().getNetworkService();

        total=(TextView)view.findViewById(R.id.avgrate_review_jongmyo);

        traffic = (ImageView)view.findViewById(R.id.rateface_traffic_review_jongmyo);
        congestion = (ImageView)view.findViewById(R.id.rateface_congestion_review_jongmyo);
        see = (ImageView)view.findViewById(R.id.rateface_see_review_jongmyo);
