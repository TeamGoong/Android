...
public class LearningChangdeok extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        first = (ImageView)view.findViewById(R.id.first_img_changdeok);
        second = (ImageView)view.findViewById(R.id.second_img_changdeok);
        third = (ImageView)view.findViewById(R.id.third_img_changdeok);
