...
public class DuksuNormalActivity extends AppCompatActivity {
    ...
    RelativeLayout payment_duksu_normal; // 결제하기 버튼

    int adult_number_duksu_palace_i, junggu_number_duksu_palace_i;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duksu_normal);
        ...
        adult_minus_duksu_palace = (ImageView)findViewById(R.id.adult_minus_duksu_palace);
        adult_plus_duksu_palace = (ImageView)findViewById(R.id.adult_plus_duksu_palace);
        adult_number_duksu_palace = (TextView)findViewById(R.id.adult_number_duksu_palace);
        adult_number_duksu_palace.setText("0");

        junggu_minus_duksu_palace = (ImageView)findViewById(R.id.junggu_minus_duksu_palace);
        junggu_plus_duksu_palace = (ImageView)findViewById(R.id.junggu_plus_duksu_palace);
        junggu_number_duksu_palace = (TextView)findViewById(R.id.junggu_number_duksu_palace);
        junggu_number_duksu_palace.setText("0");
        ...
        adult_minus_duksu_palace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(adult_number_duksu_palace_i>0){
                    adult_number_duksu_palace_i --;
                    adult_number_duksu_palace.setText(String.valueOf(adult_number_duksu_palace_i));
                }

                ticket_people_adult = "대인 "+adult_number_duksu_palace_i;
                Log.e("대인",ticket_people_adult);
            }
        });

        adult_plus_duksu_palace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                adult_number_duksu_palace_i ++;
                adult_number_duksu_palace.setText(String.valueOf(adult_number_duksu_palace_i));
        ...
        // 중구민 가감버튼 동작
        junggu_minus_duksu_palace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(junggu_number_duksu_palace_i>0){
                    junggu_number_duksu_palace_i --;
                    junggu_number_duksu_palace.setText(String.valueOf(junggu_number_duksu_palace_i));
                }
                ticket_people_junggu = "중구민 "+junggu_number_duksu_palace_i;
                Log.e("중구민",ticket_people_junggu);
            }
        });

        junggu_plus_duksu_palace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                junggu_number_duksu_palace_i ++;
                junggu_number_duksu_palace.setText(String.valueOf(junggu_number_duksu_palace_i));
        ...
        palace_id = 3; // 덕수궁 아이디
        ticket_title = "덕수궁 일반권";

        ticket_special = 0;


        // 결제하기 버튼 동작
        payment_duksu_normal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
