...
public class ReviewChanggyong extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_review_changgyong,container,false);
        networkService = GlobalApplication.getGlobalApplicationContext().getNetworkService();

        total=(TextView)view.findViewById(R.id.avgrate_review_changgyeong);

        traffic = (ImageView)view.findViewById(R.id.rateface_traffic_review_changgyeong);
        congestion = (ImageView)view.findViewById(R.id.rateface_congestion_review_changgyeong);
        see = (ImageView)view.findViewById(R.id.rateface_see_review_changgyeong);
