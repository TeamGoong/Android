...
public class ReviewGyeongbok extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_review_gyeongbok,container,false);
        networkService = GlobalApplication.getGlobalApplicationContext().getNetworkService();

        total=(TextView)view.findViewById(R.id.avgrate_review_gyeongbok);

        traffic = (ImageView)view.findViewById(R.id.rateface_traffic_review_gyeongbok);
        congestion = (ImageView)view.findViewById(R.id.rateface_congestion_review_gyeongbok);
        see = (ImageView)view.findViewById(R.id.rateface_see_review_gyeongbok);
